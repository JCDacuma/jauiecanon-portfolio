...
export default function AboutMeSection() {
  // Dynamic age calculation based on birthdate
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          <span className="inline-block text-xs sm:text-sm font-semibold tracking-widest text-emerald-800 dark:text-emerald-400 uppercase mb-2">
            Get to know me
          </span>
          <h2 className="text-3xl sm:text-4xl  font-bold text-stone-900 dark:text-stone-50">
            About{" "}
            <span className="text-emerald-800 dark:text-emerald-400">Me</span>
          </h2>
          <div className="mt-4 mx-auto w-16 h-1 rounded-full bg-emerald-600 dark:bg-emerald-500" />
        </motion.div>
          ...
          >
            <div className="relative w-full sm:max-w-[280px] max-w-[240px] sm:max-w-sm md:max-w-md">
              <motion.div
                ...
                className="relative w-[78%] aspect-4/5 overflow-hidden rounded-2xl ring-1 ring-stone-200 dark:ring-stone-700 shadow-lg shadow-stone-200/60 dark:shadow-stone-950/40 z-10"
              >
                <img
              ...
              <motion.div
                ...
                className="absolute bottom-[-8%] right-[-6%] w-[46%] aspect-square overflow-hidden rounded-xl ring-4 ring-stone-50 dark:ring-stone-800 shadow-lg shadow-stone-300/50 dark:shadow-stone-950/40 z-20"
              >
                <img
                  src="/aboutme/me.png"
                  alt="Jauie at work"
              ...
              {/* Accent glows */}
              <div className="hidden sm:block absolute -z-10 -bottom-6 -left-6 w-32 h-32 bg-emerald-400/20 dark:bg-emerald-400/10 rounded-full blur-2xl" />
              <div className="hidden sm:block absolute -z-10 -top-6 -right-6 w-24 h-24 bg-emerald-300/20 dark:bg-emerald-300/10 rounded-full blur-2xl" />
            </div>
          </motion.div>
